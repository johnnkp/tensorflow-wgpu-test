...
CPU_COMPILER = ('C:/Program Files/LLVM/bin/clang-cl.exe') # 'C:/Program Files/Microsoft Visual Studio/2022/Community/VC/Tools/MSVC/14.42.34433/bin/HostX64/x64/cl.exe')
GCC_HOST_COMPILER_PATH = ('%{gcc_host_compiler_path}')

NVCC_PATH = 'C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v12.5/bin/nvcc.exe'
NVCC_VERSION = '64_125'
NVCC_TEMP_DIR = "C:\\msys64\\tmp\\nvcc_inter_files_tmp_dir"
    ...
    if arg.startswith("@"):
      try:
        ...
        if arg.endswith("calibration_statistics_collector_average_min_max.obj.params"):
          source_path = "tensorflow/compiler/mlir/quantization/tensorflow/calibrator/"
          fo_opt += source_path
          fo_opt += "_objs/calibration_statistics_collector_average_min_max/calibration_statistics_collector_average_min_max.obj"
          cpu_compiler_flags.append(fo_opt)
          cpu_compiler_flags.append(
            source_path + "calibration_statistics_collector_average_min_max.cc"
          )
